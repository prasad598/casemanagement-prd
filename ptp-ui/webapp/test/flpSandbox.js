		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PTP Case Management",
									"targetURL": "#comstenggbtpptpui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comstenggbtpptpui-display": {
								"semanticObject": "comstenggbtpptpui",
								"action": "display",
								"description": "PTP Case Management",
								"title": "PTP Case Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.stengg.btp.ptpui",
									"url": sap.ui.require.toUrl("com/stengg/btp/ptpui")
								}
							}
						}
					}
